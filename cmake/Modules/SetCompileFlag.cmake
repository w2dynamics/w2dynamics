...
FUNCTION(SET_COMPILE_FLAG FLAGVAR FLAGVAL LANG)
    ...
    IF(LANG STREQUAL "Fortran")
	    ...
	    "option .* not supported"             # Intel (newer)
            ...
            "No such file"                        # happens with pgi on Unix for flags like /Qxhost
            "may not be used without"             # IBM xlf 
           )
    ...
    SET(FLAGLIST "" CACHE STRING "docs." FORCE)
    FOREACH (var ${ARGN})
	...
	SET(FLAG_WORKS FALSE CACHE STRING "docs..." FORCE)
